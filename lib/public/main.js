...
var DialogOverviewExampleDialog = /** @class */ (function () {
    ...
    DialogOverviewExampleDialog.prototype.addFilter = function (dropVal, filterVal) {
        var i = 1;
        var values = { dropVal: dropVal, filterVal: filterVal };
        this.items.push(i);
